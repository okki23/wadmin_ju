			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">TRACKING KURIR MANAGEMENT   </h4>
                        </div>
                            ...
                            <!-- array('id','member_id','order_id','kurir_id','no_status','status','created_at','updated_at'); -->
                                   ...
                                   <thead>
                                     <tr>
                                       ...
                                       <th style="width:25%; text-align:center;">Last Update</th>
                                   ...
                                   <tbody>
                                      ...
                                      <tr class="gradeX">
                                       ...
                                       <td style="width:20%; text-align:center;"><a href="<?php echo base_url('tracking_kurir/store/'.$row->id); ?>"> Update Status </a> &nbsp;  </td>
                                     </tr>
                                     <?php
                                     $no++;
                                     }
