 			    ...
 			    <div class="col-md-12">
                     ...
                     <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                         ...
                         <div class="panel-body">
                             <form class="form-horizontal" action="<?php echo base_url('rec_goods/save'); ?>" method="POST">
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">No Po
															 		...
															 		<div class="col-md-9">
																		<select name="no_po" id="no_po"  class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																						<option value = "">--Pilih--</option>
																						<?php foreach ($opt_po as $row){
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">Nama Barang
																	</label>
															 		<div class="col-md-9">
															 ...
															 <div class="form-group">
																 ...
																 <div class="col-md-9">
																		 <input type="text" name="harga"  id="harga" readonly="readonly"  class="form-control" />
																 </div>
															 </div>
