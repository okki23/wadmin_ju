    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">PRINT REPORT RESULT PRODUCTION</h4>
            </div>

            <div class="panel-body">
                <form class="form-horizontal" action="<?php echo base_url('rep_result_goods/process'); ?>" method="POST">

                  <div class="form-group">

                       <label class="col-md-12 control-label" style="text-align:center"> <h3> Range Tanggal Produksi </h3></label>
                       <div class="col-md-12">
                           <div class="input-group">
                               <input type="text" class="form-control" name="start" id="datepicker_start" />
                  ...
                  <div  align="center">
                     <button type="submit" name="save" class="btn btn-large btn-primary" > <i class="fa fa-archive"></i> Print </button>
