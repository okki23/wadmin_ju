 			    ...
 			    <div class="col-md-12">
                     ...
                     <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                         <div class="panel-heading">
                             ...
                             <h4 class="panel-title">RESULT OF GOODS MANAGEMENT FORM</h4>
                         </div>

                         <div class="panel-body">
                             <form class="form-horizontal" action="<?php echo base_url('res_goods/save'); ?>" method="POST">
															 <input type="hidden" name="id" value="<?php echo $parseform->id; ?>">
															 <input type="hidden" name="id_barang" id="id_barang" value="<?php echo $parseform->id_barang; ?>">
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">Kode Produksi
																	</label>

															 		<div class="col-md-9">
																		<select name="kode_produksi" id="kode_produksi"  class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																						<option value = "">--Pilih--</option>
																						<?php foreach ($opt_kode_produksi as $row){

																									echo '<option value='.$row->kode_produksi.'> '.$row->kode_produksi.' </option>';
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">Bahan Baku
																	</label>
															 		<div class="col-md-9">
															 				<input type="text" name="nama_barang" readonly="readonly"  id="nama_barang"  class="form-control" />
															 		</div>
															 </div>
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">Qty
															 		...
															 		<div class="col-md-9">
															 				<input type="text" name="qty"  id="qty" readonly="readonly"  class="form-control" />
															 		</div>
															 </div>
															 ...
															 <div class="form-group">
																 ...
																 <div class="col-md-9">
																		 <input type="text" name="satuan"  id="satuan"  readonly="readonly" class="form-control" />
																 </div>
															 </div>

															 <div class="form-group">
																 <label class="col-md-3 control-label">Tanggal Produksi
																 </label>
																 <div class="col-md-9">
																		 <input type="text" name="tgl_produksi"  id="tgl_produksi" readonly="readonly"  class="form-control" />
																 </div>
															 </div>

															 <div class="form-group">
																 <label class="col-md-3 control-label">Barang Hasil Produksi
																 </label>
																 <div class="col-md-9">
																		 <input type="text" name="barang_production"  class="form-control" />
																 </div>
															 </div>

															 <div class="form-group">
																 <label class="col-md-3 control-label">Qty Hasil Produksi
																 </label>
																 <div class="col-md-9">
																		 <input type="text" name="qty_res_production"  class="form-control" />
																 </div>
															 </div>


															 <div class="form-group">
																 <label class="col-md-3 control-label">Satuan Hasil Produksi
																 </label>
																 <div class="col-md-9">
																		 <input type="text" name="satuan_res_production"   class="form-control" />
																 </div>
															 </div>

															 <div class="form-group">
																 <label class="col-md-3 control-label">Status Hasil Produksi
																 </label>
																 <div class="col-md-9">
																	 <select name="status_res_production"  class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																					<option value = "">--Pilih--</option>
															 ...
															 <div class="form-group">
																 <label class="col-md-3 control-label">Tanggal Expired</label>
																 <div class="col-md-9">
																		 <input type="text" name="tgl_expired" class="form-control" id="datepicker-default"  value="<?php echo $parseform->tgl_produksi; ?>" />
																 </div>
															</div>
