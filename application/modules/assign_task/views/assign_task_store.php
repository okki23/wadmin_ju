 			    ...
 			    <div class="col-md-12">
                     ...
                     <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                         <div class="panel-heading">
                             ...
                             <h4 class="panel-title">ASSIGNMENT TASK FORM</h4>
                         </div>

                         <div class="panel-body">
                             <form class="form-horizontal" action="<?php echo base_url('assign_task/save'); ?>" method="POST">
															...
															<div class="form-group">
																 ...
																 <div class="col-md-9">
																	 <select name="id_claim"  readonly="readonly" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
															 ...
															 <div class="form-group">
																  <label class="col-md-3 control-label">PIC Penanggung Jawab
															 		...
															 		<div class="col-md-9">
																		<select name="id_pic"  readonly="readonly" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																					 <option value = "">--Pilih--</option>
															 ...
															 <div class="form-group">
															 	 ...
															 	 <div class="col-md-9">
																	 <select name="priority" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																					<option value = "">--Pilih--</option>
															 ...
															 <div class="form-group">
															 	 ...
															 	 <div class="col-md-9">
															 		 <select name="status"  readonly="readonly" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
															 						<option value = "">--Pilih--</option>
															 ...
															 <div class="form-group">
																 ...
																 <div class="col-md-9">
																	 	<input type="text" name="date_assign"  id="datepicker-default"  value="<?php echo $parseform->date_assign; ?>" class="form-control" />
																 </div>
															</div>
															<div class="form-group">
																 ...
																 <div class="col-md-9">
																		<input type="text" name="note" value="<?php echo $parseform->note; ?>" class="form-control" />
																 </div>
															</div>
															 ...
															 <div  align="center">
																	...
																	<a class="btn btn-danger" href="<?php echo base_url('assign_task'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
															 </div>
																 <!-- <div class="form-group">
