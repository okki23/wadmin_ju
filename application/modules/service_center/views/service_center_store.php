 			    ...
 			    <div class="col-md-12">
                     ...
                     <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                         ...
                         <div class="panel-body">
                             ...
                             <form class="form-horizontal" action="<?php echo base_url('service_center/save'); ?>" method="POST" enctype="multipart/form-data">
															 <input type="hidden" name="id" value="<?php echo $parseform->id; ?>">
															 <div class="form-group">
															 		<label class="col-md-3 control-label">Kode Service Center
																	</label>
															 		<div class="col-md-9">
															 				<input type="text" name="kode_sc" value="<?php echo $parseform->kode_sc; ?>" class="form-control" />
															 		</div>
															 </div>
                               <div class="form-group">
															 		<label class="col-md-3 control-label">Nama Service Center
																	</label>
															 		<div class="col-md-9">
															 				<input type="text" name="nama_sc" value="<?php echo $parseform->nama_sc; ?>" class="form-control"  />
															 		</div>
															 </div>
															 <div class="form-group">
																 <label class="col-md-3 control-label">Alamat Service Center
																 </label>
																 <div class="col-md-9">
																	 		<input type="text" name="alamat_sc" value="<?php echo $parseform->alamat_sc; ?>" class="form-control"  />
																 </div>
															</div>
															<div class="form-group">
																<label class="col-md-3 control-label">PIC Service Center <?php echo $parseform->pic_sc; ?>
																</label>
																<div class="col-md-9">
																	<input type="text" name="pic_sc" value="<?php echo $parseform->pic_sc; ?>" class="form-control"  />
																	<!-- <select name="pic_sc" class="form-control">
																		<?php
																		foreach ($opt_pegawai as $key => $value) {
																			if($parseform->pic_sc == $opt_pegawai->id){
														 ...
														 <div class="form-group">
															 <label class="col-md-3 control-label">No Telp Service Center
															 </label>
															 <div class="col-md-9">
																	 <input type="text" name="telp_sc" value="<?php echo $parseform->telp_sc; ?>" class="form-control"  />
															 </div>
														</div>
														<div class="form-group">
															<label class="col-md-3 control-label">Email Service Center
															</label>
															<div class="col-md-9">
																	<input type="text" name="email_sc" value="<?php echo $parseform->email_sc; ?>" class="form-control"  />
															</div>
													 </div>
                               <div class="form-group">
															 		<label class="col-md-3 control-label">Foto Service Center
																	</label>
															 		<div class="col-md-9">
															 				<input type="file" name="foto_scx" id="foto_scx" class="form-control"   />
																			<input type="hidden" name="foto_sc" id="foto_sc" value="<?php echo $parseform->foto_sc; ?>" class="form-control"   />
															 		</div>
															 </div>

															 <div  align="center">
															 		<button type="submit" name="save" class="btn btn-large btn-primary" > <i class="fa fa-archive"></i> Save </button>
																	<a class="btn btn-danger" href="<?php echo base_url('service_center'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
															 </div>
																 <!-- <div class="form-group">
