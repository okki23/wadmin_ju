...
class Tracking_api extends Parent_controller {
  ...
  var $tablename = 'tracking_numbers';
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('m_tracking_api');
 
    }

    public function index() {
      $data = $this->m_tracking_api->get_tracking();
    ...
    public function tracking_save_api(){

      $datapos = $this->m_tracking_api->input_array($this->parsing_form_input);
     
      $id = isset($datapos['id']) ? $datapos['id'] : '';
      $save = $this->m_tracking_api->save($datapos,$id,$this->tablename);
    ...
    public function tracking_delete_api(){
      $idpost = $this->input->post('id');
      $del = $this->m_tracking_api->delete($idpost,$this->tablename);
