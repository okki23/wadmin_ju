 			    ...
 			    <div class="col-md-12">
                     ...
                     <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                         <div class="panel-heading">
                             ...
                             <h4 class="panel-title">USING GOODS MANAGEMENT FORM</h4>
                         </div>

                         <div class="panel-body">
                             <form class="form-horizontal" action="<?php echo base_url('using_goods/save'); ?>" method="POST">
															...
															<input type="hidden" name="date_insert" value="<?php echo date('Y-m-d H:i:s'); ?>">
															 <div class="form-group">
															 		...
															 		<div class="col-md-9">
																		...
																		if($this->uri->segment(3) == '' || $this->uri->segment(3) == NULL ){
																			/*$loc = $nopo;*/
																			$loc = "KPRD".$kode_produksi;
																		}else{
																			$loc = $parseform->kode_produksi;
																		}
																		?>
															 				<input type="text" name="kode_produksi" value="<?php echo $loc; ?>" class="form-control"   />
															 		</div>
															 </div>
															 ...
															 <div class="form-group">
															 		...
															 		<div class="col-md-9">
																		<select name="id_barang" id="select_id_barang" class="form-control selectpicker" data-size="10" data-live-search="true" data-style="btn-white">
																						<option value = "">--Pilih--</option>
																						<?php foreach ($opt_barang as $row){
															 ...
															 <div class="form-group">
																 <label class="col-md-3 control-label">Informasi Stok</label>
																 <div class="col-md-9">
																		 <input type="text" name="informasi_stok" id="informasi_stok" readonly="readonly" class="form-control"    />
																 </div>
															</div>
															 <div class="form-group">
															 ...
															 <div class="form-group">
															 		<label class="col-md-3 control-label">Tanggal Produksi</label>
															 		<div class="col-md-9">
															 				<input type="text" name="tgl_produksi" class="form-control" id="datepicker-default"  value="<?php echo $parseform->tgl_produksi; ?>" />
															 		</div>
															 </div>
															 ...
															 <div  align="center">
																	...
																	<a class="btn btn-danger" href="<?php echo base_url('using_goods'); ?>"> <i class="fa fa-reply-all"></i> Back </a>
															 </div>
																 <!-- <div class="form-group">
