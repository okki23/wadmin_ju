                         ...
                         <div class="panel-body">
                             ...
                             <form class="form-horizontal" action="<?php echo base_url('produk/save'); ?>" method="POST" enctype="multipart/form-data">
															 ...
															 <div class="form-group">
															 		...
															 		<div class="col-md-9">
															 				<input type="text" name="kode_produk" value="<?php echo $parseform->kode_produk; ?>" class="form-control" />
															 		</div>
															 </div>
                               <div class="form-group">
															 		...
															 		<div class="col-md-9">
															 				<input type="text" name="nama_produk" value="<?php echo $parseform->nama_produk; ?>" class="form-control"  />
															 		</div>
															 </div>
                               <div class="form-group">
															 		...
															 		<div class="col-md-9">
															 				<input type="file" name="foto_produkx" id="foto_produkx" class="form-control"   />
																			<input type="hidden" name="foto_produk" id="foto_produk" value="<?php echo $parseform->foto_produk; ?>" class="form-control"   />
															 		</div>
															 </div>
