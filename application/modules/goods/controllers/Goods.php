...
class Goods extends Parent_controller {

  var $parsing_form_input = array('id','nama_barang','qty','satuan');
  var $tablename = 'm_goods';

    public function __construct() {
        parent::__construct();
        $this->load->model('m_goods','m_goods');
    ...
    public function index() {
        ...
        $data['listing'] = $this->m_goods->get_all($id=NULL,$this->tablename)->result();
        $data['parse_view'] = 'goods/goods_view';
    ...
    public function store(){
        ...
        if($id == '' || empty($id) || $id == NULL){
          $data['parseform'] = $this->m_goods->get_new($this->parsing_form_input);

        }else{
          $data['parseform'] = $this->m_goods->get_all($id,$this->tablename)->row();

        }
        $data['parse_view'] = 'goods/goods_store';
    ...
    public function save(){
      ...
      $datapos = $this->m_goods->input_array($this->parsing_form_input);
      $id = isset($datapos['id']) ? $datapos['id'] : '';
      $save = $this->m_goods->save($datapos,$id,$this->tablename);
      if($save){
        echo "<script language=javascript>
         alert('Simpan Data Berhasil');
         window.location='" . base_url('goods') . "';
             </script>";
      }
    ...
    public function delete(){
      ...
      $del = $this->m_goods->delete($idpost,$this->tablename);
    ...
    public function get_bawahan_foreman($idforeman) {
        ...
        $data['idgoods'] = $this->session->userdata('idgoods');
    ...
    public function add() {
        ...
        $data['opt_goods'] = $this->model_user_management->opt_goods();
